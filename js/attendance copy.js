...
let view_attendance_page = () => {
	...
	edited_head.splice(
		edited_head_insert,
		0,
		'<th style="vertical-align: middle; text-align: center; border-right: 1px solid #b2b2b2; padding: 5px;">75% Attendance Alert</th>'
	);
	...
	body_row.forEach((row) => {
		...
		if (row.childNodes.length > 3) {
			...
			let new_table_content_splice = document.location.href.includes("vtopcc")
				? 29
				: 37;
